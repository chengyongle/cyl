...
func (s server)Update(ctx context.Context, req *pb.UpdateReq) (*pb.UpdateResp,error){
	resp := &pb.UpdateResp{}
	log.Println("recv:",req.UserName,req.NewPassWord)
	var user dao.User
	user.Username=req.UserName
	dao.DB.Model(&user).Update("password",req.NewPassWord)
	resp.OK = true
	return resp,nil
}